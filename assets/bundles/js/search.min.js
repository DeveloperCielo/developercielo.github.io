...
"use strict";jQuery.extend({highlight:function(e,t,i,n){if(3===e.nodeType){var r=e.data.match(t);if(r){var l=document.createElement(i||"span");l.className=n||"highlight";var s=e.splitText(r.index);s.splitText(r[0].length);var a=s.cloneNode(!0);return l.appendChild(a),s.parentNode.replaceChild(l,s),1}}else if(1===e.nodeType&&e.childNodes&&!/(script|style)/i.test(e.tagName)&&(e.tagName!==i.toUpperCase()||e.className!==n))for(var h=0;h<e.childNodes.length;h++)h+=jQuery.highlight(e.childNodes[h],t,i,n);return 0}}),jQuery.fn.unhighlight=function(e){var t={className:"highlight",element:"span"};return jQuery.extend(t,e),this.find(t.element+"."+t.className).each(function(){var e=this.parentNode;e.replaceChild(this.firstChild,this),e.normalize()}).end()},jQuery.fn.highlight=function(e,t){var i={className:"highlight",element:"span",caseSensitive:!1,wordsOnly:!1};if(jQuery.extend(i,t),e.constructor===String&&(e=[e]),e=jQuery.grep(e,function(e,t){return""!=e}),0==(e=jQuery.map(e,function(e,t){return e.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")})).length)return this;var n=i.caseSensitive?"":"i",r="("+e.join("|")+")";i.wordsOnly&&(r="\\b"+r+"\\b");var l=new RegExp(r,n);return this.each(function(){jQuery.highlight(this,l,i.element,i.className)})},function(){var e=void 0,t=void 0,i={element:"span",className:"search-highlight"},n=new lunr.Index;function r(r){if(l(),t.addClass("visible"),27===r.keyCode&&(this.value=""),this.value){var s=n.search(this.value).filter(function(e){return e.score>1e-4});s.length?(t.empty(),$.each(s,function(e,i){var n=$("#"+i.ref).text();t.append("<li><a href='#"+i.ref+"'>"+n+"</a></li>")}),function(){this.value&&e.highlight(this.value,i)}.call(this)):(t.html("<li></li>"),$(".search-results li").text('No Results Found for "'+this.value+'"'))}else l(),t.removeClass("visible");$(".search-results a").click(function(){l(),t.removeClass("visible")})}function l(){e.unhighlight(i)}n.ref("id"),n.field("title",{boost:10}),n.field("body"),n.pipeline.add(lunr.trimmer,lunr.stopWordFilter),$(function(){$(":header:not(.no-toc)").each(function(){var e=$(this),t=e.nextUntil("h1, h2");n.add({id:e.prop("id"),title:e.text(),body:t.text()})})}),$(function(){e=$(".content-container .post"),t=$(".search-results"),$("#input-search").on("keyup",r),$("#input-search").on("click",r)})}();
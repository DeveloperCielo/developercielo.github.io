...
Para envio de transações com pedido de autenticação 3DS 2.0 é fundamental que, além da Cielo, o Emissor e Bandeira estejam prontos com a solução. Dentre as bandeiras do mercado, atualmente estão disponíveis Visa, Mastercard e Elo no 3DS 2.0 Cielo. As bandeiras Visa e Mastercard possuem um modelo de Stand-In, caso o Emissor ainda não esteja apto a responder um pedido de autenticação usando EMV 3DS 2.0. Nesse cenário, a bandeira avalia os dados enviados, como por exemplo o histórico comportamental do cliente e transacional, classificando os pedidos de autenticação como “Baixo Risco” e “Não Baixo Risco”. A partir dessas informações, os Emissores poderão contar com uma proteção mesmo não possuindo uma solução própria de 3DS 2.0, e terão uma maior confiança nas transações autenticadas. Em casos de Stand-In, a autenticação ocorre de forma silenciosa (sem desafio para o portador) e, uma vez que a transação foi autenticada, o liability em caso de fraude ficará com o Emissor. A decisão de autorizar ou não a transação é do Emissor. Em transações autenticadas pela bandeira, a decisão de autorizar ou não a transação ainda é do Emissor, onde este, ainda pode negar as transações na etapa de autorização da transação.

|                     |                        |                                       | **BANDEIRAS**                                                                              |
| **BANCO EMISSOR**   | ADESÃO DE COMÉRCIOS    | LISTA DE BINS APTOS PARA AUTENTICAÇÃO | **VISA**       | **MASTERCAD**            | **ELO**                | **American Express**  |
| Banco do Brasil     | Sob análise do emissor | Total                                 | Crédito/Débito | Crédito/Débito - em replanejamento | Crédito/Débito - em replanejamento | Ago/2020                 |
| Bradesco            | Aberto para o mercado  | Parcial                               | Crédito/Débito | Crédito/Débito - 30/07   | Crédito/Débito - em fase de testes até 30/07 | 31/10                 |
| Caixa Econômica     | Aberto para o mercado  | Parcial                               | Crédito Pronto<br>Débito - 4Q 2020 | Crédito - 30/08<br>Débito - 4T 2020 | Crédito - 30/08<br>Débito - 4T 2020  | ---                   |
| Santander           | Aberto para o mercado  | Total                                 | Crédito/Débito | Crédito/Débito           | ---                    | ---                   |
| Itaú                | Sob análise do emissor | Parcial                               | Crédito/Débito | Crédito/Débito           | ---                    | ---                   |
| Nubank              | Sob análise do emissor | Total                                 | ---            | Crédito/Débito Parcial - Conclusão 18/07 | ---                    | ---                   |
| Banco Original      | Aberto para o mercado  | Total                                 | ---            | Crédito/Débito em Testes | ---                    | ---                   |
| C6BANK              | Aberto para o mercado  | Total                                 | ---            | Crédito/Débito           | ---                    | ---                   |
| Banco Neon          | Aberto para o mercado  | Total                                 | Crédito        | ---                      | ---                    | ---                   |
| Acesso              | Aberto para o mercado  | Total                                 | ---            | Crédito                  | ---                    | ---                   |
| Porto Seguro        | Aberto para o mercado  | Total                                 | Crédito        | ---                      | ---                    | ---                   |
| Pagbank             | Aberto para o mercado  | Total                                 | Crédito/Débito | Crédito/Débito           | ---                    | ---                   |
| Midway              | Aberto para o mercado  | Total                                 | Crédito        | ---                      | ---                    | ---                   |
| Realize             | Aberto para o mercado  | Total                                 | ---            | Crédito                  | ---                    | ---                   |
| Pernambucanas       | Aberto para o mercado  | Total                                 | ---            | ---                      | Crédito                | ---                   |

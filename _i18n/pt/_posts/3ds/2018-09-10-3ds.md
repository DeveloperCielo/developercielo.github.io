...
A solução é composta pelo passo de solicitação de token de acesso via API. Para implementação em websites, acesse o manual de [Autenticação via Java Script](https://developercielo.github.io/manual/integracao-javascript){:target="_blank"}.

...
Para ter acesso ao Swagger com a especificação de cada recurso, basta acessar no nosso[Portal de Desenvolvedores Cielo](https://desenvolvedores.cielo.com.br/api-portal/pt-br/swagger)

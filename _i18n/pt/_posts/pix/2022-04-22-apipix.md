...
O Pix Automático é uma solução para facilitar pagamentos recorrentes. Com ele, o usuário pagador precisa apenas realizar uma autorização prévia para que o pagamento seja efetuado automaticamente na frequência previamente combinada.
...
Essa solução preenche lacunas atualmente existentes no mercado de meios de pagamento, ao oferecer maior simplicidade para a empresa recebedora. Com ela, o recebedor pode operar utilizando apenas um único provedor de Pix Automático, o que aumenta a eficiência, reduz a carga operacional e acelera processos. Além disso, aproveita a agilidade do Pix, que possui liquidação instantânea, garantindo a identificação e baixa do pagamento de forma imediata.

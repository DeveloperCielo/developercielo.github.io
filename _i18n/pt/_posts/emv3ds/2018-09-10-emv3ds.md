...
| **Cartão** | **Resultado** | **ECI** | **Descrição** |
| 4000000000001000 | SUCCESS | 05 | Autenticação Silenciosa e portador autenticou com sucesso |
| 4000000000001018 | FAILURE | 07 | Autenticação Silenciosa e portador finalizou com falha|
| 4000000000001034 | UNENROLLED | 07 | Cartão não elegível para autenticação |
| 4000000000001091 | SUCCESS | 05 | Autenticação com desafio e portador autenticou com sucesso|
| 4000000000001117 | UNENROLLED | 07 | Autenticação com desafio e Cartão não elegível |
| 4000000000001109 | FAILURE | 07 | Autenticação com desafio e portador falhou na autenticação |

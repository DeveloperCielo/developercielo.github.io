...
<aside class="notice">Emissores já prontos com solução própria de 3DS 2.0 Visa: Caixa (Crédito – atualmente com autenticação silenciosa, sem desafio), Santander (Débito e Crédito), Itaú (Crédito – atualmente com autenticação silenciosa, sem desafio), Porto Seguro (Crédito), Banco Neon (Crédito) e Midway (Crédito).</aside>

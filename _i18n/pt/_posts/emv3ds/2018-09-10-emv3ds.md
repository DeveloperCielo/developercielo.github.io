...
<aside class="notice">Emissores já prontos com solução própria de 3DS 2.0 Visa: Caixa (Crédito), Banco do Brasil (Débito e Crédito), Santander (Débito e Crédito) e Itaú (Débito e Crédito – atualmente com autenticação silenciosa, sem desafio).</aside>

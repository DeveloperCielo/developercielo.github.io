...
| Payment.ExternalAuthentication.Cavv | Booleano que indica se a transação é submetida o não para o processo de autenticação| Alfanumérico [28 posições] | Sim, quando a autenticação foi um sucesso |
...
| Payment.ExternalAuthentication.Eci | E-Commerce Indicator retornado no processo de autenticação | Numérico [até 3 posições] | Sim |
| Payment.ExternalAuthentication.Version | Versão do 3DS utilizado no processo de autenticação | Alfanumérico [1 posições] | Sim, quando a versão do 3DS for &quot;2&quot; |

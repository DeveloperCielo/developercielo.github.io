...
Endpoint é a URL para onde as requisições com os dados do carrinho serão enviadas. Todas as requisições deverão ser enviadas utilizando o método HTTP POST, para o endpoint `https://cieloecommerce.cielo.com.br/api/v1/orders`.
...
```shell
curl -X POST "https://cieloecommerce.cielo.com.br/api/v1/orders" \
     -H "MerchantId: 00000000-0000-0000-0000-000000000000" \
...
curl_setopt($curl, CURLOPT_URL, 'https://cieloecommerce.cielo.com.br/api/v1/orders');
...
headers = {"Content-Type": "application/json", "MerchantId": "00000000-0000-0000-0000-000000000000"}
request = Request("https://cieloecommerce.cielo.com.br/api/v1/orders", data=json, headers=headers)
...
headers  = {:content_type => "application/json",:merchantid => "00000000-0000-0000-0000-000000000000"}
response = RestClient.post "https://cieloecommerce.cielo.com.br/api/v1/orders", request, headers
...
try {
    url = new URL("https://cieloecommerce.cielo.com.br/api/v1/orders");
...
HttpWebRequest request = (HttpWebRequest)
                         WebRequest.Create("https://cieloecommerce.cielo.com.br/api/v1/orders");
...
![Amount]({{ site.baseurl_root }}/images/checkout-discount-amount.png)
...
![Percent]({{ site.baseurl_root }}/images/checkout-discount-percent.png)

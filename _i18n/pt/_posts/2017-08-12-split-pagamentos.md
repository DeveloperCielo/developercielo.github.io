...
|-----------|---------- |
| **Marketplace** | Responsável pelo carrinho. <BR> Possui acordos com **Subordinados** que fornecem os produtos presentes no carrinho.<BR> Define as taxas a serem descontados sobre a venda do **Subordinado**.<BR> Pode participar de uma venda fornecendo seus próprios produtos. |

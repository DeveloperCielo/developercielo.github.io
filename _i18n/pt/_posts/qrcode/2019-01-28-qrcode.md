...
|`technology.identifier`|Campo proveniente do QRCode, veja [Dê-para QR Code x Recurso Payments](https://developercielo.github.io/manual/qrcode#d%C3%AA-para-qr-code-x-recurso-payments) Texto alfanumérico|16|Sim|

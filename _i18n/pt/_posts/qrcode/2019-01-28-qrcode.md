...
|`merchantAccountInformation.id`|Número do estabelecimento comercial. Campo proveniente do QRCode, [Veja layout](https://developercielo.github.io/manual/qrcode#d%C3%AA-para-qr-code-x-recurso-payments)|Número|1|Sim|

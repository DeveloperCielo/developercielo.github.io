...
|`card_data`|Dados do cartão criptografado pela chave publica, [Veja layout](https://developercielo.github.io/manual/qrcode-v2#card-data)| Texto alfanumérico||Sim|

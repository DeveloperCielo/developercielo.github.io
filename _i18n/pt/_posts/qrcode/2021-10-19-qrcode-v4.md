...
>|HTTP STATUS CODE|Code|Descrição|
>|---|---|---|
...
>|422|003|QRCode expirado. Erro de negócio referente a expiração do tempo de validade do QRCode|
>|422|004|Dados de cartão inválido.Erro de negócio referente a problemas nos dados do cartão informado|
...
>|422|412. 155|O documento do cliente não foi reconhecido. Ele  dever ser um CPF ou CNPJ válido|
>| 400  | 412.101  | O campo 'key_id' é obrigatório |
>| 400  | 412. 102  | O campo 'card_data' é obrigatório |
>| 400  | 412. 104  | O campo 'qr_code' é obrigatório |
>| 400  | 412. 156  | O CPF enviado não é válido |
>| 400  | 412. 157  | O CNPJ enviado não é válido |

**Detalhamento dos códigos de erros do Payment**

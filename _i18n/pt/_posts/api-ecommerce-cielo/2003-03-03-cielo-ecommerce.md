...
| `MerchantAdviceCode`                 | Código de retorno da bandeira que define período para retentativa. _Válido somente para bandeira Mastercard_. Veja mais informações sobre Merchant Advice Code em [Programa de retentativa das bandeiras](https://developercielo.github.io/manual/cielo-ecommerce#programa-de-retentativa-das-bandeiras){:target="\_blank"}.| Texto        | 2       | Numérico                             |

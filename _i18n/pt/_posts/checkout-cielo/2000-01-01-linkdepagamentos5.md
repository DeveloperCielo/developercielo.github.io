...
A Associação Brasileira das Empresas de Cartão de Crédito e Serviços (ABECS) estabeleceu, desde 15 de julho de 2020, a padronização do código de retorno das autorizações de vendas negadas tanto para as soluções pagamento do mundo físico e e-commerce do mercado brasileiro.

> Para ver a relação completa dos códigos de retorno, acesse a tabela [Códigos de retorno ABECS](https://developercielo.github.io/tutorial/abecs-e-outros-codigos){:target="_blank"}.

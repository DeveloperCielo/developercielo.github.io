...
<aside class="notice"><strong>Atenção:</strong> Nessa modalidade de recorrência, a primeira transação deve ser autorizada. Todas as transções posteriores serão capturadas automaticamente.</aside>

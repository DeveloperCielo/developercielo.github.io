...
<nav style="display:flex;justify-content:space-between;">
    <nav style="max-width:240px;">
        ...
        <a href="https://developer.android.com/reference/android/app/job/JobScheduler.html">Referência</a>
    </nav>
    <nav style="max-width:240px;">
        ...
        <a href="https://developer.android.com/reference/android/location/LocationManager.html">Referência</a>
    </nav>
    <nav style="max-width:240px;">
        ...
        <a href="https://www.mapbox.com">Referência</a>
    </nav>
</nav>

...
| **Especificações**        | **DX8000**                  | **L300 (LIO V3)**           | **L400**                     | **L300 (V4)**           |
|---------------------------|-----------------------------|-----------------------------|------------------------------|-----------------------------|
...
| **Frequência GSM MHz**    | Quad-Band                   | Quad-Band                  | Não identificado             | B2/B3/B5/B8                |
| **Tamanho em polegadas**  | 5.5"                        | 5"                         | 6.5"                         | 5"                         |
| **Tipo de tela**          | AMOLED                      | AMOLED                     | TFT painel IPS               | IPS                        |
| **Resolução da tela**     | 720 x 1280                  | 720 x 1280                 | 720 x 1600                   | FW 480 x 854               |
| **Densidade de pixels**   | 1080p                       | 267 ppi                    | 269,92 ppi                   | 196 ppi                    |
| **Câmera**                | 5 Mega Pixels               | 5 Mega Pixels              | Frontal: 2MP / Traseira: 2MP | Sim                        |
| **Resolução da câmera**   | 4160 x 3120 pixels          | 4160 x 3120 pixels         | 2MP Traseira / 2MP Frontal   | 2MP + 5MP                  |
| **Flash**                 | Flash LED                   | Flash LED                  | Flash LED                    | Sim                        |
...
**3**. Selecione **Cielo LIO - Order Manager - Integração Remota 1.0.0** para realizar a integração via Deep link.  

**4**. Clique em **Registrar** para concluir o processo. 

![Registrando credenciais](../../../../images/cielo-lio/cadastrandocredenciaisapi.png)
...
**3**. Selecione **Cielo LIO - Order Manager - Integração Remota 1.0.0** para realizar a integração Remota.  

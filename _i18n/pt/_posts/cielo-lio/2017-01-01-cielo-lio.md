...
![Impressão Texto Simples]({{ site.baseurl_root }}/images/cielo-lio/print-text.png)
...
Resultado final da impressão
![Impressão Múltiplas Colunas]({{ site.baseurl_root }}/images/cielo-lio/print-columns.png)
...
|-----------------------|-----------------|
| ![Impressão Imagem]({{ site.baseurl_root }}/images/cielo-lio/cielo.png) | ![Impressão Imagem]({{ site.baseurl_root }}/images/cielo-lio/print-image.png) |

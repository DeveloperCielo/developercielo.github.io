...
<aside style="background-color: #d4edda; padding: 15px; border-left: 5px solid #28a745; color: #155724;margin-top: 20px; margin-bottom: 20px;"> A impressora térmica do terminal LIO deve ser utilizada com bobinas que atendam às seguintes especificações: papel azul com gramatura de 48 g/m², comprimento de 12 metros, diâmetro máximo de 30 milímetros e largura de 57 milímetros.</aside>
...
A Cielo Smart oferece a solução de pagamento cashless via integração. Suportamos os cartões Mifare 1k. Para utilizar o serviço no aplicativo de integração, siga os passos abaixo:
...
- Envie intents direcionadas ao pacote mencionado.

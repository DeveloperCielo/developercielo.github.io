...
<aside style="background-color: #d4edda; padding: 15px; border-left: 5px solid #28a745; color: #155724;margin-top: 20px; margin-bottom: 20px;">  O terminal com debug é voltado para o desenvolvimento e depuração, incluindo símbolos de debug que permitem o uso de breakpoints, inspeção de variáveis e exibição de mensagens de erro detalhadas. Ele também pode conter validações extras, como assertions, o que torna sua execução mais lenta. Já o terminal sem debug é otimizado para distribuição e desempenho. Ele remove símbolos de depuração, reduz ou desativa logs e mensagens de erro, aplica otimizações para acelerar a execução e gera um binário menor e mais seguro, ideal para ambientes de produção. </aside>

![selecionando solicitação](../../../../images/cielo-lio/solicitandoliodev.png)
...
![formulário de solicitação](../../../../images/cielo-lio/formulariodesolicitacao.png)
...
> **Somente aplicativos de loja pública são disponibilizados na Cielo Store.**

...
**Compatibilidade ampliada** – use seu app em novos terminais sem desenvolvimento adicional
**Mais robustez e velocidade** – melhor tempo de aprovação nos pagamentos
**Smart First** – todas as melhorias e novas funcionalidades serão implementadas somente na Cielo Smart
...
1. Incluir uma nova tag no arquivo AndroidManifest.xml para que o App possa ser distribuído corretamente para os terminais no processo de publicação
...
2. Garantir a compatibilidade com o Android 10 (permissões, notificações, criação de intents, etc)

<aside class="warning">A Integração via SDK será descontinuada..</aside>
...
Para saber mais, acesse [AQUI](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-h%C3%ADbrida) a documentação de Integração via Deeplink
...
- Chamadas via intenet, de forma que aplicativos de parceiros possam se integrar com as funcionalidades de pagamento da Cielo LIO.
  Acesse Documentação da [Integração via Deeplink](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-h%C3%ADbrida)
...
[Ir para integração via Deeplink](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-h%C3%ADbrida)
...
#### Preciso de uma máquina Cielo LIO para realizar os testes?

...
| **Especificações**        | **L300 (LIO V3)**           | **L300 (V4)**           | **DX8000**                  | **L400**                     |
|---------------------------|-----------------------------|-----------------------------|-----------------------------|------------------------------|
| **Versão**                | L300 (LIO V3)              | L300 (V4)              | DX8000                      | L400                         |
| **Sistema operacional**   | Android 7.1 (Nougat)       | Android 11                 | Android 10 Security OS      | Android 11                   |
| **Memória**               | 1GB RAM                    | 2GB RAM                    | 1GB RAM                     | 2GB RAM                      |
| **Armazenamento**         | 8 GB                       | 32 GB                      | 8 GB                        | 32 GB                        |
| **Dual Chip**             | Não                        | Não                        | Sim                         | Sim                          |
| **Frequência**            | 2.4GHz + 5.0 GHz           | 4G, 3G e 2G                | 2.4GHz + 5.0 GHz            | 2.4GHz + 5.0 GHz             |
| **Tipo do SIM Card**      | 1 SIM card (2FF) + ESIM    | Mini SIM                   | 2 SIM card (2FF) + ESIM     | 2x SIM / 1x SAM / 1x MicroSD |
| **Frequência GSM MHz**    | Quad-Band                  | B2/B3/B5/B8                | Quad-Band                   | Não identificado             |
| **Tamanho em polegadas**  | 5"                         | 5"                         | 5.5"                        | 6.5"                         |
| **Tipo de tela**          | AMOLED                     | IPS                        | AMOLED                      | TFT painel IPS               |
| **Resolução da tela**     | 720 x 1280                 | FW 480 x 854               | 720 x 1280                  | 720 x 1600                   |
| **Densidade de pixels**   | 267 ppi                    | 196 ppi                    | 1080p                       | 269,92 ppi                   |
| **Câmera**                | 5 Mega Pixels              | Sim                        | 5 Mega Pixels               | Frontal: 2MP / Traseira: 2MP |
| **Resolução da câmera**   | 4160 x 3120 pixels         | 2MP + 5MP                  | 4160 x 3120 pixels          | 2MP Traseira / 2MP Frontal   |
| **Flash**                 | Flash LED                  | Sim                        | Flash LED                   | Flash LED                    |
| **USB**                   | USB Tipo C                 | Tipo-C                     | USB Tipo C                  | USB-C                        |
| **Bluetooth**             | Versão 4.2                 | 5.0                          | Indisponível                | 5.0                          |
| **WiFi**                  | 802.11a/b/g/n(2.4GH+5.0GHz)| Dual Band                  | 802.11a/b/g/n(2.4GH+5.0GHz) | 2.4GHz e 5GHz                |
| **GPS**                   | GPS + A-GPS, Glonass       | GPS / A-GPS / GLONASS      | GPS + A-GPS, Glonass        | GPS / AGPS / GLONASS / Beidou|
| **Sensores**              | Acelerômetro, Prox. e Lumin| Não                        | Acelerômetro, Prox. e Lumin | NA                           |
| **Saída de áudio**        | Audio Jack 3.5mm           | Speaker + Entrada 3.5mm    | Não                         | Não identificado             |
| **Peso**                  | 417 g                      | 450 g                      | 450 g                       | 450 g                        |
| **Altura**                | 70mm                       | 202mm                      | 198mm                       | 50mm                         |
| **Largura**               | 82mm                       | 79mm                       | 83mm                        | 79mm                         |

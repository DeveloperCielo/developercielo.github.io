...
**1**. Primeiro, declare a visibilidade do pacote (Android 11+). A partir do Android 11 (API 30), é obrigatório declarar explicitamente a visibilidade do pacote `com.ads.lio.uriappclient` para que seu aplicativo consiga interagir com o serviço de integração UriApp.

Essa exigência surgiu devido às novas restrições de visibilidade de pacotes introduzidas no Android 11, com o objetivo de reforçar a privacidade e a segurança do sistema. Sem a declaração explícita em queries, o sistema operacional não permitirá que seu aplicativo:

- Detecte a presença do serviço `com.ads.lio.uriappclient`
- Envie intents para o pacote especificado
...
Não. O emulador tem como finalidade simular o sistema dos terminais e, por isso, deve ser instalado apenas em dispositivos como tablets ou em emuladores Android (AVD) com as versões 7.1 ou 10 do sistema operacional. 
...
**Por que recebo o erro EACCES (permission denied) ao tentar imprimir imagens via DeepLink no emulador da LIO?**  

...
| primaryProductCode        | string        | Código do produto primário                                                | 4                                      |
...
| secondaryProductCode      | string        | Código do produto secundário                                              | 205                                    |
...
- Consultando um pedido pelo seu identificador (ID). <br/>
<br/>
...
> O campo statusCode=1 indica uma transação de pagamento e statusCode=2, um Cancelamento. Você pode utilizar esse campo para identificar a transação de cancelamento no JSON recebido.

...
Os aplicativos públicos são indicados para aqueles desenvolvedores e parceiros que desejam disponibilizar e escalar sua aplicação, disponibilizando o app para o marketplace Cielo Store de forma que o estabelecimento comercial (lojista) possam identificar e selecionar os aplicativos que melhor os atendem.

Caso o aplicativo não seja gratuito (valor único ou mensalidade), os valores serão repassados dentro da agenda financeira.

> **Atenção:** Após o upload do arquivo não é possível trocar de loja pública para loja privada. 

[Clique aqui](https://www.cielo.com.br/cielo-store/) para saber mais sobre a Cielo Store.
...
### Upload de novos Aplicativos e Novas versões 
...
No caso de Aplicativo privado o desenvolvedor deverá solicitar a distribuição para as LIOs que devem receber seu aplicativo.
...
> **Atenção:** A utilização do paymentCode referente ao PIX está disponivel para uso na versão 1.7.0 da SDK. Para utilização é necessário que esse meio de pagamento esteja habilitado junto a Cielo.

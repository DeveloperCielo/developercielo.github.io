...
A cada transação/pagamento realizados em um pedido, o servidor do Order Manager envia, via comando, as informações para o Backend do parceiro.
...
- O envio da notificação para um pedido será retentado a cada 15 minutos, durante um período total de 7 horas.
- Em caso de falha em todas as retentativas neste período, as notificações deste pedido serão bloqueadas.
...
- [Entre em contato conosco](https://developercielo.github.io/manual/cielo-lio#suporte-t%C3%A9cnico) para solicitar o desbloqueio, informando o número do EC e o endereço do serviço, caso haja alteração.

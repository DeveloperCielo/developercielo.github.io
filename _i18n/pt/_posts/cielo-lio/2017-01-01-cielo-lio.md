...
![LIO V2](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/images/liov2.png)

![LIO ON](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/images/cielo-lio-on_resized.png)
...
Acesse agora o [Dev Console](https://www.cieloliostore.com.br/) e faça o seu cadastro!
...
A LIO não possui o modo debug. Esse cadastro do equipamento como Dev consiste em enviarmos um aplicativo ao seu equipamento com o nome "Test Your App" e atráves desse aplicativo você efetuará a leitura de um QRCode gerado ao submeter o seu app no DevConsole. Para mais info [Clique Aqui](https://developercielo.github.io/manual/cielo-lio#promover-aplicativo-para-desenvolvimento)
...
Acesse o nosso projeto de exemplo em: [Flutter](https://desenvolvedores.cielo.com.br/api-portal/content/solicitar-tokens-para-producao)

...
| price        | Número              | Valor total do pedido em centavos. Exemplo: O valor de R$ 10,00 é representado como 1000.                                                             | Sim             |
| remaining    | Número              | Valor restante do pagamento do pedido em centavos. Exemplo: O valor de R$ 10,00 é representado como 1000.                                             | Sim             |
...
| terminal_number    | Número | Número do terminal da Cielo Smart em que o pagamento foi realizado.          | Sim         |
...
| amount             | Número | Valor da transação em centavos. Exemplo: O valor de R$ 10,00 é representado como 1000. | Sim         |
...
<aside style="background-color: #f8d7da; padding: 15px; border-left: 5px solid #dc3545; color: #721c24;margin-top: 20px; margin-bottom: 20px;">  Os campos podem sofrer alterações sem aviso prévio, recomendamos que o PARSE do json seja dinâmico para aceitar novos valores em campos que ja enviamos hoje. Exemplo: O campo brand, caso surja novas bandeiras o seu backend precisa estar pronto para essa alteração. </aside>

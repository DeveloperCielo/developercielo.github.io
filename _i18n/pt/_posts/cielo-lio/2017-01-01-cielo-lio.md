...
| Bluetooth            | Versão 4.2                  | Versão 4.2                  |
...
A desinstalação deve ser realizada diretamente pelo cliente. Para o cliente desinstalar um aplicativo privado, primeiro é necessário que você desassocie o EC da loja privada, para que assim o cliente prossiga com as próximas etapas:
...
<aside class="warning"> A senha é disponibilizada no Dev Console, acesse Meus aplicativos, clique em Apps privados, depois em “Ver detalhes” do aplicativo desejado e clique em “Desinstalar app” para visualizar a senha.</aside>

...
- **Retorno de erro**: O parâmetro `result` retornará uma String com um valor diferente de `R00`, e o identificador do cartão não será retornado no parâmetro `data`.

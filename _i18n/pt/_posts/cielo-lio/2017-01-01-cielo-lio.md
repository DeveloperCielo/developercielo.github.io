...
## Comunicado Importante - Foi prorrogado o prazo para adaptação do app público e/ou privado para a Cielo Smart

Ainda não adaptou o seu app? Adapte já e garanta a compatibilidade com a **Cielo Smart!**

O prazo para adaptação de app público e/ou privado foi prorrogado para **06/04/2025**.

A partir de **07/04/2025**, não será possível realizar o upload de um novo app ou de uma nova versão público ou privado na Cielo Store Dev Console que **não esteja adaptado a Cielo Smart**.

- Garanta a compatibilidade com o Android 10 (permissões, notificações, criação de intents etc.)
...
 
Em caso de dúvidas, entre em [contato conosco](https://devcielo.zendesk.com/hc/pt-br#suporte).
...
Primeiro baixe e instale o aplicativo, download [aqui no link](https://s3-sa-east-1.amazonaws.com/cielo-lio-store/apps/lio-emulator/1.60.4/lio-emulator.apk)

...
**Impressora térmica**: o cliente poderá ter a 1ª e 2ª via impressa após o pagamento realizado. Além disso, 0.as aplicações parceiras poderão utilizar os métodos disponíveis da impressora para imprimir dados importantes ou necessários para o negócio do cliente.
...
```
compile 'com.cielo.lio:order-manager:0.18.3'
```

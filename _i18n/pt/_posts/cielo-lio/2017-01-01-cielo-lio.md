...
Resultado final da impressão
![Impressão Múltiplas Colunas]({{ site.baseurl_root }}/images/cielo-lio/print-columns.png | width=100)
...
|-----------------------|-----------------|
| ![Impressão Imagem]({{ site.baseurl_root }}/images/cielo-lio/cielo.png | width=100) | ![Impressão Imagem]({{ site.baseurl_root }}/images/cielo-lio/print-image.png | width=100) |

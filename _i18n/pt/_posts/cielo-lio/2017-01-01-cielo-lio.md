...
1. Efetuar o upload do apk no Dev Console.

2. Deve clicar em "instalar" na versão desejada, dentro da tela de detalhes do aplicativo, para gerar o QR Code.

![Devconsole](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/instalarapp.png)

3. Abrir o aplicativo "Test Your App" em sua LIO de desenvolvimento e apontar para o QR Code gerado no Dev Console.

![QR Code](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/qrcode.png)

4. A versão do app será baixada na Lio.

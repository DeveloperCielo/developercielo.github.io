...
**1.** Acesse a página de [Suporte a desenvolvedores](https://devcielo.zendesk.com/hc/pt-br)
**2.** Selecione a opção **Cielo Smart Lio**.
**3.** Clique em **Envie sua pergunta**.

![abrindo um chamado](../../../../images/cielo-lio/enviesuaperguntasmart.png)

**4.** Escolha o assunto sobre o qual você precisa de ajuda.
**5.** Preencha os campos obrigatórios como **Assunto**, **Número do EC** e **Descrição** da sua dúvida.
**6.** Clique em **Enviar**.

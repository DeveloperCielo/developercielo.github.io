...
<aside style="background-color: #d4edda; padding: 15px; border-left: 5px solid #28a745; color: #155724;margin-top: 20px; margin-bottom: 20px;"> O campo statusCode=0(apenas pagamentos pix) ou 1 indica uma transação de pagamento e statusCode=2 Cancelamento. </aside> 
...
| v40Code                   | string        | Tipo da transação                                                         | 28 para cancelamento, 4 para pagamento e 7 para autorização           |
...
| cardCaptureType           | string        | Códigos do tipo de captura do cartão                               | Códigos: EMV = 0; DIGITADO: 1; TRILHA_1 e TRILHA_2 = 2; CTLS_EMV e CTLS_TRILHA = 3; QRCODE = 6; NONE, TIBC_10, TIBC_30 e EASY_ENTRY = -1.)          |
...
Na listagem de pedidos, é possível obter os pedidos (orders) abertos na Cielo Smart pelo aplicativo do parceiro. Para isso, basta definir o JSON abaixo e formata-lo para Base64:

...
> **Atenção:** A utilização do paymentCode referente ao PIX está disponivel para uso na versão 1.7.0 da SDK. É necessário que o estabelecimento esteja habilitado junto a Cielo para a utilização desse tipo de pagamento.

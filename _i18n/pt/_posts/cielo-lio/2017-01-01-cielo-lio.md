...
### Exemplo de classe para tratamento utilizando broadcast

Abaixo disponiblizamos um exemplo de solução que trta o retorno das operações mifare utilizando broadcast

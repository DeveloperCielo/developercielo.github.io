...
```
dependencies {    
  implementation 'com.cielo.lio:order-manager:1.7.2'  
}
```
...
https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-local 
...
 
Documentação Integração Remota:
https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-remota 
...
https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-h%C3%ADbrida 
...
1 - Clique na aba “Ajuda”;
2 - Clique na opção “Minha LIO”;
3 - Clique na opção “Buscar Atualizações”;
...
3 - Clique em “Criar cadastro” Informe os dados requisitados.
...
A partir da Loja Privada criada, o desenvolvedor poderá publicar seu aplicativo no Dev Console selecionando sua loja, esta ação é essencial para realizar a distribuição de aplicativos privados. https://devcielo.zendesk.com/hc/pt-br para solicitar a criação da Loja Privada.
...
1 - No canto superior direito, clique em “Acessar minha conta;
2 - Clique em “Cadastre-se”;
3 - Clique em “Criar cadastro” Informe os dados requisitados.

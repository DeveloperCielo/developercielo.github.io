...
| !LIO V3 | ![DX8000](https://desenvol------------------------|-----------------------------|-----------------------------|
| **Versão**                | LIO V3                      | DX8000                      | L400 |
...
| **Dual Chip**             | -                           | Sim                         | Sim |
| **Frequência**            | 2.4GHz + 5.0 GHz            | 2.4GHz + 5.0 GHz            |Não especificado |
| **Tipo do SIM Card**      | 1 SIM card (2FF) + ESIM     | 2 SIM card (2FF) + ESIM     | 2x SIM / 1x SAM / 1x MicroSD |
| **Frequência GSM Mhz**    | Quad-Band                   | Quad-Band                   | Não especificado |
| **Tamanho em polegadas**  | 5"                          | 5.5"                        | 6.5" |
| **Tipo de tela**          | AMOLED                      | AMOLED                      | Não especificado |
| **Resolução da tela**     | 720 x 1280                  | 720 x 1280                  | 720 x 1600 |
| **Densidade de pixels**   | 267 ppi                     | 1080p                       | Não especificado |
...
| **Flash**                 | Flash LED                   | Flash LED                   | Não especificado |
...
| **Sensores**              | Acelerômetro, Prox. e Lumin | Acelerômetro, Prox. e Lumin | Não especificado |
| **Saída de áudio**        | Audio Jack 3.5mm            | -                           | Não especificado

...
Abaixo, você encontra a lista completa de valores aceitos para o campo `paymentCode`, que devem ser utilizados na configuração da requisição de pagamento conforme o tipo de transação desejada.

...
* Client-Id
Identificação de acesso. Sua geração ocorre no momento da criação pelo painel do desenvolvedor. Seu valor pode ser visualizado na coluna Client ID, dentro do menu ['Client ID Cadastrados'](https://desenvolvedores.cielo.com.br/api-portal/pt-br/myapps)

* Access-Token
Identificação do token de acesso, que armazena as regras de acesso permitidas ao Client ID. Sua geração ocorre no momento da criação do Client ID pelo painel do desenvolvedor. Seu valor pode ser visualizado clicando em 'detalhes' na coluna 'Access Tokens', dentro do menu ['Client ID Cadastrados'](https://desenvolvedores.cielo.com.br/api-portal/pt-br/myapps)

[Crie sua Credencial para a API Local](https://desenvolvedores.cielo.com.br/api-portal/pt-br/myapps/new)
...
| Você pode pegar outros dados diretamente do objeto payments    |
...
>**Atenção:** Para a utilização do EC, é necessário uma pré habilitação junto a Cielo, para o recebimento com MULTI-EC
...
Na consulta de pedidos, é possível informar o parâmetro REFERENCE, para identificar as ordens criadas conforme mostrado no exemplo abaixo:

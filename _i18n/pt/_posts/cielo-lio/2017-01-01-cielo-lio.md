...
![fluxo](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Fluxo_com_selecao_de_produto_0.png)
...
![fluxo sem selecao produto](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Fluxo_sem_selecao_de_produto_0.png)
...
4. (Client ID e Access-Token) e consegue utilizar o Cielo LIO Order Manager SDK. Realize os testes no  Cielo Lio Confira o link: [Download do Emulador](https://s3-sa-east-1.amazonaws.com/cielo-lio-store/apps/lio-emulator/1.60.2/lio-emulator.apk))

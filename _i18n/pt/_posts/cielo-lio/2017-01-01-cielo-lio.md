...
![DX8000](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/dx8000.jpg)
...
Se você optou pela loja privada, é necessário que solicite a criação dela para o envio do app. Para criar loja: acesse o [Portal do Desenvolvedor](https://desenvolvedores.cielo.com.br/api-portal/pt-br), clique em *Suporte* > *Cielo LIO* e depois, no botão *“Envie sua pergunta”*. Para finalizar, selecione o tipo de solicitação *Criação Loja Privada* e preencha o formulário. 
...
![NovoAplicativo](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/NovoAplicativo.png)

 - Após a seleção, será exibido um modal: *“Organize estas informações”*, clique em *“Continuar”* e realize o upload do arquivo do aplicativo com o formato .apk com o tamanho de até 200MB. **ATENÇÃO: Após o upload do arquivo não é possível trocar de loja privada para pública.**

![NovoAplicativo2](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/NovoAplicativo2.png)
...
Oferecemos um aplicativo para facilitar a validação da sua integração com a LIO On, suportando [integração híbrida](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-h%C3%ADbrida) e a [integração local com a SDK ](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-local).
...
Primeiro baixe e instale o aplicativo, download [aqui no link](https://s3-sa-east-1.amazonaws.com/cielo-lio-store/apps/lio-emulator/1.58.5/lio-emulator.apk)
...
![fluxo](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Fluxo_com_selecao_de_produto.png)
...
![fluxo sem selecao produto](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Fluxo_sem_selecao_de_produto.png)
...
![order manager sdk fluxo](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Criacao_e_gerenciamento_de_ordens.png)
...
![checkoutorder formas](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Processo_de_pagamento.png)
...
| Data | No contexto de uma operação de leitura, o parâmetro devolve os dados lidos do cartão. Se a operação for de detecção do cartão, o parâmetro retorna o identificador dele. Para todas as outras operações, o retorno é nulo | `ByteArray` |
...
<aside class="warning">A factory BitmapFactory, usada para criação do bitmap, gera um bitmap que precisa ser arbitrariamente liberado após o uso, através do método bitmap.recycle(), caso contrário o garbage collector não liberará o recurso. Basta chamar o método recycle() do bitmap, após seu uso, para que o recurso seja liberado.</aside>

| Imagem a ser impressa                                                                              | Resultado final                                                                                          |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| ![Impressão Imagem](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Logo.png){:height="50%" width="50%"} | ![Impressão Imagem 2](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/impressao_Cielo.png){:height="25%" width="25%"} |
...
4. (Client ID e Access-Token) e consegue utilizar o Cielo LIO Order Manager SDK. Realize os testes no  Cielo Lio Confira o link: [Download do Emulador](https://s3-sa-east-1.amazonaws.com/cielo-lio-emulator/latest-release/lio-emulator.apk)
...
![integração remota](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Integracao_remota.png)
...
![status do pedido](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Status_de_pedido.png)
...
![fluxo_basico](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/API_Order_Manager_Cielo.png)
...
Download do Emulador: [aqui no link](https://s3-sa-east-1.amazonaws.com/cielo-lio-store/apps/lio-emulator/1.58.5/lio-emulator.apk)

...
> **Atenção:** A utilização do paymentCode referente ao PIX estará disponivel para uso na versão 1.7.0 da SDK e será liberado para utilização no inicio de Dezembro/2023. É necessário que esse meio de pagamento esteja habilitado junto a Cielo.

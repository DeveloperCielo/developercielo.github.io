...
Essa atualização foi projetada para aprimorar a experiência do cliente, incorporando o PIX, melhorias na contagem de linhas impressas nos comprovantes, o que resulta na oferta de bobinas gratuitas aos clientes, além da remoção da opção de parcelamento para o cliente. Estamos comprometidos em aprimorar constantemente a experiência do usuário final.

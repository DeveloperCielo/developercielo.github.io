...
| | ![LIO V2](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/lio_v2_small.png) |
|----------------------|---------------------------------------------|
| Versão               | **LIO V2**                                  |
| Sistema operacional  | Android OS Cielo 6.0 (Marshmallow)          |
| Memória              | 1GB LPDDR3                                  | 
| Armazenamento        | -                                           |
| Dual Chip            | -                                           |
| Frequência           | 2.4 GHz                                     | 
| Tipo do SIM Card     | micro SIM (3FF)                             | 
| Frequência GSM Mhz   | Quad-Band 850/900/1800/1900                 | 
| Tamanho em polegadas | 5.5"                                        | 
| Tipo de tela         | AMOLED                                      | 
| Resolução da tela    | 720 x 1280 pixels                           |                
| Densidade de pixels  | 267 ppi                                     |
| Câmera               | 13 Mega Pixels                              |
| Resolução da câmera  | 4160 x 3120 pixels                          |
| Flash                | Flash LED                                   |
| USB                  | USB 2.0 Micro-B (Micro-USB) Somente Energia |
| Bluetooth            | Versão 4.0 com A2DP/LE                      |
...
Recomenda-se que o desenvolvedor utilize para a Cielo LIO+ o APK target version 27 e versão mínima 22 (essa última para garantir compatibilidade).

## Cielo e App padrão de vendas
...
> **Atenção**: O modelo da LIO+ não possui a aba de pedidos para a utlização na Integração Remota, a integração deve acontecer com os
modelos LIO v1 e LIO v2.

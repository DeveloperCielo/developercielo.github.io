...
![Terminais Smart](../../../../images/cielo-lio/terminaissmartatualizados2026.png)

Abaixo, você encontra as especificações técnicas dos modelos disponíveis: 


| **Especificações**        | **DX8000**                  | **L300 (LIO V3)**           | **L300 (V4)**           | **L400**                     |
|---------------------------|-----------------------------|-----------------------------|-----------------------------|------------------------------|
| **Versão**                | DX8000                      | L300 (LIO V3)              | L300 (V4)              | L400                         |
...
| **Dual Chip**             | Sim                         | Não                        | Não                        | Sim                          |
| **Frequência**            | 2.4GHz + 5.0 GHz            | 2.4GHz + 5.0 GHz           | 4G, 3G e 2G                | 2.4GHz + 5.0 GHz             |
| **Tipo do SIM Card**      | 2 SIM card (2FF) + ESIM     | 1 SIM card (2FF) + ESIM    | Mini SIM                   | 2x SIM / 1x SAM / 1x MicroSD |
| **Frequência GSM MHz**    | Quad-Band                   | Quad-Band                  | B2/B3/B5/B8                | Não identificado             |
| **Tamanho em polegadas**  | 5.5"                        | 5"                         | 5"                         | 6.5"                         |
| **Tipo de tela**          | AMOLED                      | AMOLED                     | IPS                        | TFT painel IPS               |
| **Resolução da tela**     | 720 x 1280                  | 720 x 1280                 | FW 480 x 854               | 720 x 1600                   |
| **Densidade de pixels**   | 1080p                       | 267 ppi                    | 196 ppi                    | 269,92 ppi                   |
| **Câmera**                | 5 Mega Pixels               | 5 Mega Pixels              | Sim                        | Frontal: 2MP / Traseira: 2MP |
| **Resolução da câmera**   | 4160 x 3120 pixels          | 4160 x 3120 pixels         | 2MP + 5MP                  | 2MP Traseira / 2MP Frontal   |
| **Flash**                 | Flash LED                   | Flash LED                  | Sim                        | Flash LED                    |
| **USB**                   | USB-C                       | USB-C                      | USB-C                      | USB-C                        |
| **Bluetooth**             | Indisponível                | Versão 4.2                 | 5.0                        | 5.0                          |
| **WiFi**                  | 802.11a/b/g/n(2.4GH+5.0GHz) | 802.11a/b/g/n(2.4GH+5.0GHz)| Dual Band                  | 2.4GHz e 5GHz                |
| **GPS**                   | GPS + A-GPS, Glonass        | GPS + A-GPS, Glonass       | GPS / A-GPS / GLONASS      | GPS / AGPS / GLONASS / Beidou|
| **Sensores**              | Acelerômetro, Prox. e Lumin | Acelerômetro, Prox. e Lumin| Não                        | NA                           |
| **Saída de áudio**        | Não                         | Audio Jack 3.5mm           | Speaker + Entrada 3.5mm    | Não identificado             |
| **Peso**                  | 450 g                       | 417 g                      | 450 g                      | 450 g                        |
| **Altura**                | 198mm                       | 70mm                       | 202mm                      | 50mm                         |
| **Largura**               | 83mm                        | 82mm                       | 79mm                       | 79mm                         |
| **Comprimento**           | 62.5mm                      | 205mm                      | 68mm                       | 186mm                        |

...
* O processo é executado no intervalo de **15 minutos**.
* São feitas até **28 tentativas** de notificação, caso não obtenha sucesso, todas as notificações do pedido serão bloqueadas.

#### Bloqueio do EC

* O processo é executado **uma vez ao dia**.
* É feito o bloqueio do EC quando o percentual de pedidos bloqueados for igual ou superior **80%** considerando as últimas **24 horas**.

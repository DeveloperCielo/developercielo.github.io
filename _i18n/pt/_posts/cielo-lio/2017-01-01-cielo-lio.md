...
- Monitoramento do SO: A versão do sistema operacional pode ser acompanhada via ferramenta de Observabilidade. <br/>
<br/>  
...
- Nova opção para reiniciar comunicação: Substitui o modo avião pela função “Reiniciar comunicação”, que realiza o mesmo processo. <br/>
<br/> 
...
- Corrigido erro na ativação do Cashless via integração DeepLink/UriApp. <br/>
<br/> 

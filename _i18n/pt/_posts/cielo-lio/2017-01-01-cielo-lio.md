...
- ***Integração via Deeplink**: Esse modelo utiliza deep links para permitir que aplicativos Android se comuniquem diretamente com os recursos da Cielo. [Clique aqui](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-via-deeplink5) para aprender mais sobre a integração via Deeplink. 

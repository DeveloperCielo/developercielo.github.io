...
<aside class="warning">Atenção: O emulador utilizado na integração com SDK (Integração Local) não funciona para esse modelo de integração. Os testes são feitos diretamente no equipamento</aside>
...
Disponiblizamos 2 exemplos em diferentes linguagens:

Acesse o projeto em: [React Native](https://github.com/DedoJr/cieloReturnPayments)

Acesse o projeto em Flutter: [Flutter](https://desenvolvedores.cielo.com.br/api-portal/content/solicitar-tokens-para-producao)

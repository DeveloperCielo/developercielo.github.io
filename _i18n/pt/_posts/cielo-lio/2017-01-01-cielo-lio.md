...
Adicione ao `AndroidManifest.xml` da sua aplicação: <uses-permission android:name="android.permission.INTERNET" />
...
```
    ServiceBindListener serviceBindListener = new ServiceBindListener() {
        ...
        public void onServiceBound() {
            ...
            //A partir desse momento você pode utilizar as funções do OrderManager, 

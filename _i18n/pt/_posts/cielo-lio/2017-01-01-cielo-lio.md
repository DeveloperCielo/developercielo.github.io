...
Casa passo dessa jornada está detalhado nas seções deste portal, como explicamos a seguir.
...
Para migrar:
-  Utilize a [integração via Deeplink](https://developercielo.github.io/manual/cielo-lio#integra%C3%A7%C3%A3o-via-deeplink).
...
Se você já utiliza a integração via Deeplink, veja abaixo como se adaptar a Cielo Smart: 

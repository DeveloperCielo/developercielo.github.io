...
| LIO V1                                        | LIO V2                                        |
|-----------------------------------------------|-----------------------------------------------|
| **1**: Gerencie suas vendas                   | **1**: Gerencie suas vendas                   |
| **2**: Wi-Fi + 3G                             | **2**: Wi-Fi + 3G                             |
| **3**: Tela touch                             | **3**: Tela touch                             |
| **4**: loja de aplicativos Cielo Store        | **4**: loja de aplicativos Cielo Store        |
| **5**: Sistema operacional Cielo OS (Android) | **5**: Sistema operacional Cielo OS (Android) |
| **6**: Aceita um monte de cartões             | **6**: Aceita um monte de cartões             |
| **7**: Teclado físico                         | **7**: Teclado físico                         |
| **8**: Câmera com leitor de código de barras  | **8**: Câmera com leitor de código de barras  |
| **9**: Flash integrado                        | **9**: Flash integrado                        |
| **10**: Carregador                            | **10**: Carregador                            |
...
Os desenvolvedores que desejam obter uma Cielo LIO, podem se credenciar na Cielo e solicitar o equipamento. Todo esse procedimento pode ser realizados via [site da Cielo](www.cielo.com.br).
...
[CLIQUE AQUI](https://desenvolvedores.cielo.com.br/api-portal/content/ajuda-dev) para solicitar a habilitação de sua LIO para LIO de Dev.
...
[CLIQUE AQUI](https://desenvolvedores.cielo.com.br/api-portal/content/ajuda-dev) para solicitar a criação da Loja Privada.
...
A certificação de aplicativos da Cielo LIO visa garantir os seguintes pontos:
...
[CLIQUE AQUI](https://desenvolvedores.cielo.com.br/api-portal/content/ajuda-dev)
...
[CLIQUE AQUI](https://desenvolvedores.cielo.com.br/api-portal/content/ajuda-dev) para solicitar a distribuição de seu aplicativo.

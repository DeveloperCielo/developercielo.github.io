...
Você será redirecionado para uma tela que exibirá o **Client ID** e **Merchant ID**. Para ver **Access Tokens**, clique em **detalhes**. 
...
| Ambiente   | Endpoint                                                                |
|------------|--------------------------------------------------------------------------|
| Sandbox    | `https://api.cielo.com.br/sandbox-lio/order-management/v1/orders`              |
| Produção   | `https://api.cielo.com.br/order-management/v1/orders`                          |
...
| Ambiente   | Endpoint                                                                |
|------------|--------------------------------------------------------------------------|
| Sandbox    | `https://api.cielo.com.br/sandbox-lio/order-management/v1/orders/{id}`              |
| Produção   | `https://api.cielo.com.br/order-management/v1/orders/{id}`                          |

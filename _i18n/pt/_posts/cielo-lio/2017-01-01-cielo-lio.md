...
1. Entre no DevConsole e selecione a opção “+ Aplicativos”. Ao clicar nessa opção irá apresentar o seguinte pop-up mostrando a diferença dos tipos de lojas.

![NOVO APLICATIVO](https://desenvolvedores.cielo.com.br/api-portal/sites/default/files/Novo_Aplicativo.png)

2. Selecione a opção Loja Pública e clique em “Subir App”. Irá apresentar uma mensagem no qual esteja concordando que **“Após o upload do arquivo não é possível trocar de loja pública para privada.”**

3. Suba o arquivo do aplicativo e aperte em salvar.
...
5. Aplicativo sendo aprovado. O parceiro será notificado através do Dev Console, sendo assim poderá colocar seu app em produção. O aplicativo após ser promovido para produção está disponível na Vitrine da Cielo Store.

...
```
compile 'com.cielo.lio:order-manager:0.17.16'
```
...
```java
orderManager.checkoutOrder(orderId, value, installments,  paymentListener);
```
...
Esse método é disponibilizado para o caso de ser necessário efetuar um pagamento em um EC diferente do configurado na LIO.
Nessa forma de pagamento, é necessário apenas fazer a chamada do método enviando os seguintes parâmetros:

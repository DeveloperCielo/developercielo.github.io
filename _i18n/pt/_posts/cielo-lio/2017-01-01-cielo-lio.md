...
| reference    | String               | Referência do pedido. Utilizada para facilitar o acesso ou a localização do mesmo.                                                        | Não             |
...
| notes        | String               | Campo disponível para uso do Merchant para comunicação.                                                                                   | Não             |
...
| payment_code    | String              |   “Forma de pagamento estabelecida na criação do pedido. Caso não seja informado, será necessário escolher a forma no POS”. Funcionalidade exclusiva para Cielo Smart.                                          | Não             |
...
| unit_price      | Number | Valor unitário do produto. Exemplo: O valor de R$ 10,00 é representado como 1000.                                           | Sim         |
...
Um cancelamento só pode ser realizado em seu valor integral.

...
|-----------|--------------|-------------|-------------|
| **Categoria 1**<br> **Emissor não aprovará novas tentativas**   | **Irreversível** | 04 - Reter cartão <br>07 - Reter cartão, condições especiais<br>12 - Transação inválida  <br>14 - Número de conta inválido^1<br>15 - Emissor não existe<br> 41 -Reter cartão (cartão perdido) <br>  43 - Reter cartão (cartão roubado)  <br>  46 - Conta encerrada   <br> 57 - Transação não permitida ao portador de cartão    <br> R0 - Parar ordem de pagamento   <br>  R1 - Revogação do pedido de autorização  <br>  R3 - Revogação de todos os pedidos de autorização  <br>   | Cobrança de tarifa a partir da 2ª tentativa. |
...
\^1 *O código 14 será reclassificado a partir de 24/04/2024, mas permanece na categoria 1*.

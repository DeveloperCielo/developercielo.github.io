...
* The process runs at the interval of **15 minutes**.
* Up to **28** notification attempts are made, if unsuccessful, all order notifications will be blocked.

#### EC Block

* The process runs **once a day**.
* The EC is blocked when the percentage of blocked orders is equal to or greater than **80%** considering the last **24 hours**.

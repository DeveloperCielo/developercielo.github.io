...
> **Payment Scheme**: Settlement time-limit according to product (credit or debit) and brand. <br> > **Credit**: First installment in up to 31 days, remaining installments in each 30 days <br> > **Debit**: In up to 2 business days.
...
> **MDR (_Merchant Discount Rate_):** Percentage to be deducted from the amount of a transaction, defined by product (Credit / Debit), brand and installment range. <br> > **Fixed Fee:** The amount, in cents, to be charged for each captured transaction.

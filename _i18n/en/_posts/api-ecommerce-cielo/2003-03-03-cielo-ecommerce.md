...
| `FraudAnalysis.Cart.Items.Passenger.Rating`   | Text     | -       | No                  | Passenger's classification. <br>Field Values: "Adult" (Adult passenger) <br>"Child" (Child passenger) <br> "Infant" (Child Passenger) <br>"Youth" (Teenage passenger) "Student" (Student passenger) <br>"SeniorCitizen" (Old passenger) <br>"Military" (Military passenger)|

...
| `FraudAnalysis.Cart.Items.HostHedge`          | Text     | ---     | No                  | Level of importance of e-mail and IP addresses of clients at risk of scoring.<br> _"Low"_ (Low importance of e-mail and IP address in risk analysis) importance of e-mail and IP address in risk analysis) _"High"_ (High importance of e-mail and IP address in risk analysis) _"Off"_ (Email and address IP Does Not Affect Risk Analysis) |
...
| `FraudAnalysis.Cart.Items.PhoneHedge`         | Text     | 6       | No                  | Nível dos testes realizados com os Numbers de telefones.<br>_“Low”_(Baixa importância nos testes realizados com Numbers de telefone)<br>_“Normal”_(Média importância nos testes realizados com Numbers de telefone)<br>_“High”_(Alta importância nos testes realizados com Numbers de telefone)<br>_“Off”_(Testes de Numbers de telefone No afetam a análise de risco)|

...
|`Payment.PaymentDateTime`|String|date-time|Yes|Transaction capture Date and Time|
|`Payment.Amount`|Integer(int64)|---|Yes|Transaction amount (1079 = R$10,79)|
|`CreditCard.ExpirationDate`|String|MM/yyyy|Yes|Data de validade do cartão. <br><br>Dado obtido através do comando PP_GetCard na BC no momento da captura da transação.|
...
|`CreditCard.BrandId`|Integer|---|Yes|Identificação da bandeira obtida através do campo BrandId da PRODUCT TABLE.|
|`CreditCard.IssuerId`|Integer|---|Yes|Código do emissor obtido através do campo IssuerId da BIN TABLE.|

...
See below the representation of a standard **transactional flow** in the integration of an e-wallet, using an encrypted card:
...
| `Type`                              | Wallet type: "ApplePay" / "SamsungPay" / "GooglePay"                                                                                            | Text | --      | Alphanumeric text                                                                                                   |

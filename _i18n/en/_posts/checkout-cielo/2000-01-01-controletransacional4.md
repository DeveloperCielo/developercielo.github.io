...
| `Token_type`   | Will always be of the `bearer` type                 | texto  |
...
Querying transactions via the transactional control API can be done in two ways:

* By **Merchant_Order_Number** - Order number sent by the merchant
* By **Checkout_Cielo_Order_Number** - Order number generated by Checkout Cielo.
...
> The fields and sizes are described in the [Checkout Cielo Integration manual](https://developercielo.github.io/manual/checkout-cielo)

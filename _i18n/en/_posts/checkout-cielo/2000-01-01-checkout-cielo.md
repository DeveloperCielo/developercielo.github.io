...
* **Closing date**: date on which the recurrence process stops occurring.
...
## Changing recurrence data

To change recurrence data, access the **Cielo website**, where you can change:

* **Activation**: a recurrence can be activated or canceled;
* **Interval**: it is possible to modify the execution interval;
* **Recurrence day**: it is possible to modify the execution day of the recurring transaction.
<br/>
Access the [Backoffice Checkout Cielo Tutorial](https://developercielo.github.io/en/tutorial/checkout-tutoriais) for more information.

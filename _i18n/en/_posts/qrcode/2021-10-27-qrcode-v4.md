---
layout: manual
title: Integration Manual - v2 - v4
...
|`card_data`|Card data encrypted by the public key, [See layout](https://developercielo.github.io/manual/qrcode-v2#layout-card-data)|String|Yes|

...
The solution is composed by the access token request via the API and authentication request via Java Script. For deployment in websites, see [Javascript Authentication](https://developercielo.github.io/en/manual/integracao-javascript){:target="_blank"}.
...
See more details at [Autorização com Autenticação](https://developercielo.github.io/en/manual/autorizacao-com-autenticacao)
...
# Authorization for Data Only Transactions (API 3.0)

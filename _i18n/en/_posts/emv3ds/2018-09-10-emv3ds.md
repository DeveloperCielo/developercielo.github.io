...
<aside class="notice"> Issuers that are ready with its own solution of 3DS 2.0 Visa: Caixa (Credit – currently with silent authentication, no challenge), Santander (Debit and Credit) e Itaú (Debit and Credit – currently with silent authentication, no challenge). </aside>

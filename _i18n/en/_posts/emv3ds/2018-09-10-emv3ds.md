...
1. Javascript Authentication: ideal for deployment in [websites](https://developercielo.github.io/manual/integracao-javascript)
2. SDK Android Authentication: ideal for deployment in-app Android **(coming soon)**
3. SDK IOS Authentication: ideal for deployment in-app IOS **(coming soon)**

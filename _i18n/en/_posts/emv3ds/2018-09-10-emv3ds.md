...
| bpmpi_auth_suppresschallenge | Boolean that indicates if ignore or not the challenge. If the challenge is ignored, the liability will keep with the merchant.  | Boolean: <br>true – ignore challenge <br>false – perform challenge | Yes | Yes |
...
| --- | --- | --- | --- | --- |
| Payment.Authenticate | Defines whether the buyer will be directed to the Issuing bank for card authentication | Boolean | - | Yes, for authentication to be performed it is required to send as true |
| Payment.ExternalAuthentication.Cavv | Signature returned in case of successfull authentication | Alphanumeric | 28 | Yes (_when authentication is successfull_) |
| Payment.ExternalAuthentication.Xid | XID returned in the authentication process | Alphanumeric | 28  | Yes (_when 3DS version is  &quot;1&quot;_) |
| Payment.ExternalAuthentication.Eci | E-Commerce Indicator returned in authentication process | Numeric [1]| Max 3 | Yes |
| Payment.ExternalAuthentication.Version | 3DS version used in authentication process | Alphanumeric | Numeric [1] | Yes, (_when 3DS version is  &quot;2&quot;_) |
| Payment.ExternalAuthentication.ReferenceId | RequestID returned in authentication process | GUID | 36 | Yes (_when 3DS version is  &quot;2&quot;_) |
...
| **Parameter** | **Description** | **Type** | **Size** | **Mandatory** |
| --- | --- | --- | --- | --- |
| cavv | Signature returned in case of successfull authentication | Alphanumeric | 28 | Yes (_when authentication is successfull_) |
| xid | XID returned in the authentication process | Alphanumeric | 28 | Yes (_when 3DS version is  &quot;1&quot;_) |
| eci | E-Commerce Indicator returned in authentication process | Numeric [1] | Max 3 | Yes |
| versao | 3DS version used in authentication process | Numeric [1] | Yes, (_when 3DS version is  &quot;2&quot;_) |
